    ...
    <div class="lg:card flex flex-row justify-center md:flex-col items-center  md:py-0 lg:py-0">
        ...
        <div class='md:flex md:flex-col md:items-center'>
            <div class="p-4 md:text-center w-[100%] md:w-[75%] lg:w-full md:h-[12rem]">
                <h3 class="text-[#0A2A45] font-rosario text-[17px]md:text-[14px] lg:text-[28px]  lg:text-xl font-semibold mb-2 lg:mt-[1rem] lg:mb-[1rem]">Constelación familiar
                    individual. 
                </h3>
...
<div class="lg:card flex flex-row justify-center md:flex-col items-center  md:py-0 lg:py-0">
        ...
        <div class='md:flex md:flex-col md:items-center'>
            <div class="p-4 md:text-center w-[100%] md:w-[75%] lg:w-full md:h-[12rem] ">
                <h3 class="text-[#0A2A45]  font-rosario text-[17px]md:text-[14px] lg:text-[28px] lg:text-xl font-semibold mb-2 lg:mt-[1rem] lg:mb-[1rem]">Sanación espiritual 
                    con guías.</h3>
...
<div class="lg:card flex flex-row justify-center md:flex-col items-center  md:py-0 lg:py-0">
        ...
        <div class='md:flex md:flex-col md:items-center'>
            <div class="p-4 md:text-center w-[100%] md:w-[75%] lg:w-full md:h-[12rem] ">
                <h3 class="text-[#0A2A45]  font-rosario text-[17px]md:text-[14px] lg:text-[28px] lg:text-xl font-semibold mb-2 lg:mt-[1rem] lg:mb-[1rem]">Sanación con <br> maestros.</h3>
...
<div class="lg:card flex flex-row justify-center md:flex-col items-center  md:py-0 lg:py-0">
        ...
        <div class='md:flex md:flex-col md:items-center'>
            <div class="p-4 md:text-center w-[100%] md:w-[75%] lg:w-full md:h-[12rem] ">
                <h3 class="text-[#0A2A45]  font-rosario text-[17px]md:text-[14px] lg:text-[28px] lg:text-xl font-semibold mb-2 lg:mt-[1rem] lg:mb-[1rem]">Sanación de fallecidos y 
