    ...
    <nav id="site-navigation" class="navbar">
        <div class="logo">
            <a href="<?php echo get_site_url(); ?>/#inicio">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/consthera_logo.svg" alt="logo">
            </a>
        </div>
        <div class='navbar__links'>
            <ul class="links font-custom">
                <li><a href='<?php echo esc_url( home_url( '/about-consthera/' ) ); ?>'
                        class='font-rosario font-bold'>Acerca de</a><span class='span'>|</span></li>
                <li><a href='<?php echo esc_url( home_url( '/nuestros-servicios/' ) ); ?>'
                ...
                <li><a href='<?php echo esc_url( home_url( '/contacto/' ) ); ?>' class='font-rosario font-bold'>Contáctanos</a>
                </li>
            ...
            <div class="icon-text flex flex-row items-center">
                ...
                <div class="flex flex-col">
                    <a href="https://wa.me/528141485521" target="_blank"
                        class="text-[16px] text-white no-underline font-custom">(+52) 8141485521</a>
                </div>
            </div>
        </div>
        <div class="social-item">
