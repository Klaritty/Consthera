...
<body>
    ...
    <main id="sanacion-fallecidos">
        <section class=' hidden md:block bg-cover bg-no-repeat bg-center'
            style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/images/S_06_cover_back_desk.jpg');"'>
            <div class=' pb-[6rem] pt-[8rem] container mx-auto'>
            <h1 class='text-center pb-[2rem] font-belleza text-[30px] md:text-[60px] text-white'>SANACIÓN DE FALLECIDOS Y CONTACTO CON ELLOS.
            </h1>
            <div class=" w-[10%] mx-auto border-[#BD9062] border-t-2 mb-[2rem]"></div>
            <div class='flex justify-center items-center'>
                <p class='text-center mx-auto font-rosario text-[17px] md:text-[26px] w-[70%] text-white'>$1800 MXN- 45 a
                    60 minutos</p>
            </div>
        ...
        <section id='home'>
            <div class='py-[4rem] px-4 md:w-[50%] mx-auto'>
                <div class='mb-[2.5rem] flex flex-col gap-[3rem]'>
                    <p class='text-justify font-rosario'>Abrimos las puertas a un mundo más allá de lo tangible. Es común entrar en contacto con seres queridos que han cruzado al otro lado, brindándote la oportunidad de resolver lo pendiente y encontrar la sanación emocional que necesitas.</p>
                    <p class='font-rosario text-justify'>
                    Experimenta la liberación emocional al conectar con tus seres queridos fallecidos y transmitirles aquello que no pudiste expresar en vida. Nuestro enfoque se centra en ayudar a estas almas a encontrar la paz y la luz para trascender al más allá. 
                    </p>
                </div>
                ...
                <div class='mb-[2.5rem] py-[2rem] flex flex-col items-center'
                    ...
                    <p class='font-rosario text-justify'>
                    "Libera las cargas emocionales pendientes con tus seres queridos, facilitando su transición hacia la luz del más allá y encontrando paz en tu corazón."
                    </p>
                </div>

                <div class='pb-[4rem]  flex flex-col gap-[3rem]'>
                    <p class='font-rosario text-justify'>Siente la presencia reconfortante de tus seres queridos fallecidos, comunicate con ellos y libera cualquier carga emocional que aún te afecte, encuentra consuelo y sanación, permitiéndote avanzar en tu camino con serenidad y amor.</p>
                    <p class="font-rosario text-justify">No pospongas más la oportunidad de conectarte con tus seres queridos en el más allá. Reserva tu sesión de Sanación de Fallecidos y Contacto con Ellos hoy mismo y comienza el proceso de liberación.</p>
                </div>
                ...
                <div class="flex flex-col md:flex-row justify-center items-center  md:py-0 lg:py-0">
                    ...
                    <div class="w-full md:w-[50%] ">
                        <div class='mt-[2rem] md:mt-0 flex items-center justify-center'>
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/home_serv_6.jpg"
