...
<section id='services' class=' hidden md:block bg-cover bg-no-repeat bg-center' style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/images/home_hero_back_desk.jpg');">
    <div class='pb-[6rem] pt-[9.6rem] container mx-auto'>
        ...
        <div class='pb-[4rem] flex justify-center items-center'>
            <h2 class='text-center mx-auto font-rosario text-[23px] w-[70%] text-white'>¡Reserva una sesión hoy mismo, estés donde estés! Ya sea en línea o de maneta presencial en Monterrey, estamos aquí para ofrecerte apoyo en tu viaje hacia la sanación y el equilibrio con nuestras terapias exclusivas.
            </h2>
        </div>
    </div>
</section>
