    ...
    <div id="grid-container" class="grid grid-cols-2 gap-y-10 container mx-auto justify-between">
        ...
        <div class="rounded-lg  text-center w-[70%] mx-auto col-span-2 md:col-span-1"
            ...
            <p class="text-white text-[14px] mb-2 leading-tight">Descubre una oportunidad única para liberarte de
                bloqueos pasados
                y tener paz. Ya sea por reconciliación, sanación de relaciones, síntomas físicos o claridad financiera,
                nuestro enfoque te guía hacia una transformación profunda.</p>
            <h2 class="text-lg text-white font-semibold mb-2">$600 MXN- 45 a 60 minutos.</h2>
        ...
        <div class="rounded-lg  text-center w-[70%] mx-auto col-span-2 md:col-span-1"
            ...
            <p class="text-white text-[14px] mb-2 leading-tight">Encuentra respuestas y avanza hacia la plenitud.
                Conectamos con
                tus guías para más energía, orientación en decisiones físicas, proyectos y contacto con ellos, actuando
                como un traductor hacia la sanación.</p>
        ...
        <div class="rounded-lg  text-center w-[70%] mx-auto col-span-2 md:col-span-1"
            ...
            <p class="text-white text-[14px] mb-2 leading-tight">Guía a tus seres queridos fallecidos hacia la paz,
                sanando y
                resolviendo lo pendiente, diles aquello que no pudiste en vida y acompáñalos hacia la luz del más allá
                para una transición pacífica.</p>
            <h2 class="text-lg text-white font-semibold mb-2">$1800 MXN- 45 a 60 minutos.</h2>
            <div class="flex items-center justify-center p-[1rem]">
        ...
        <div class="rounded-lg  text-center w-[70%] mx-auto col-span-2 md:col-span-1"
            ...
            <p class="text-white text-[14px] mb-2 leading-tight">¡Eleva la energía de tu hogar o negocio! Despídete de
                la
                negatividad, las entidades y las emociones estancadas para dar vida a un espacio lleno de vitalidad.
                Envía tu ubicación y déjanos hacer el resto.</p>
            <h2 class="text-lg text-white font-semibold mb-2">$1700 MXN- 90 a 120 minutos.</h2>
            <div class="flex items-center justify-center p-[1rem]">
        ...
        <div class="rounded-lg  text-center w-[70%] mx-auto col-span-2 md:col-span-1"
            ...
            <p class="text-white text-[14px] mb-2 leading-tight">Eliminamos las energías negativas y entidades que
                podrían
                desencadenar accidentes y fallas emocionales con tu energía, viaja de forma segura y armoniosa. ¡Tu
                seguridad en la carretera es nuestra prioridad!</p>
