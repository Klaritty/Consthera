...
<div id="grid-container" class="grid grid-cols-2 container mx-auto">
  ...
  $cardsData = array(
    array(
      ...
      "button1Text" => "VER MÁS",
      "button2Text" => "RESERVA",
      "link" => esc_url(home_url('/constelacion-familiar-individual/')),
      "link2" => esc_url(home_url('/#/'))
    ),
    array(
      ...
      "button1Text" => "VER MÁS",
      "button2Text" => "RESERVA",
      "link" => esc_url(home_url('/constelacion-familiar-en-pareja/')),
      "link2" => esc_url(home_url('/#/'))
    ),
    array(
        ...
        "button1Text" => "VER MÁS",
        "button2Text" => "RESERVA",
        "link" => esc_url(home_url('/sanacion-con-guias/')),
        "link2" => esc_url(home_url('/#/'))
      ),
      array(
        ...
        "button1Text" => "VER MÁS",
        "button2Text" => "RESERVA",
        "link" => esc_url(home_url('/sanacion-akashica/')),
        "link2" => esc_url(home_url('/#/'))
      ),
      array(
        ...
        "button1Text" => "VER MÁS",
        "button2Text" => "RESERVA",
        "link" => esc_url(home_url('/sanacion-con-maestros/')),
        "link2" => esc_url(home_url('/#/'))
      ),
      array(
        ...
        "button1Text" => "VER MÁS",
        "button2Text" => "RESERVA",
        "link" => esc_url(home_url('/sanacion-de-fallecidos-y-contacto-con-ellos/')),
        "link2" => esc_url(home_url('/#/'))
      ),
      array(
        ...
        "button1Text" => "VER MÁS",
        "button2Text" => "RESERVA",
        "link" => esc_url(home_url('/limpieza-energetica-de-casa-o-negocio/')),
        "link2" => esc_url(home_url('/#/'))
      ),
      array(
        ...
        "button1Text" => "VER MÁS",
        "button2Text" => "RESERVA",
        "link" => esc_url(home_url('/limpieza-energetica-a-personas-animales-o-plantas/')),
        "link2" => esc_url(home_url('/#/'))
      ),
      array(
        ...
        "button1Text" => "VER MÁS",
        "button2Text" => "RESERVA",
        "link" => esc_url(home_url('/limpieza-energetica-de-autos-transportes/')),
        "link2" => esc_url(home_url('/#/'))
      ),
