...
<section id='home' class='container mx-auto'>
    <div class='pb-[6rem] pt-[8rem]'>
        <h1 class='text-center pb-[2rem] font-belleza text-[60px]'>Historia</h1>
        ...
        <div class="lg:card flex flex-row justify-center md:flex-col items-center md:py-0 lg:py-0">
             <div class='md:flex md:flex-col md:items-center'>
                <div class="p-4 md:text-center md:w-[70%] md:h-[10rem]">
                     <h3 class="text-black font-belleza text-[17px] md:text-[14px] lg:text-xl font-semibold mb-2 lg:mt-[1rem] lg:mb-[1rem]">Especialidad en constelaciones familiares.  
                     </h3>
        ...
        <div class="lg:card flex flex-row justify-center md:flex-col items-center md:py-0 lg:py-0">
             <div class='md:flex md:flex-col md:items-center'>
                <div class="p-4 md:text-center md:w-[70%] md:h-[10rem]">
                     <h3 class="text-black font-belleza text-[17px] md:text-[14px] lg:text-xl font-semibold mb-2 lg:mt-[1rem] lg:mb-[1rem]">Canalización con guías y seres espirituales. 
                     </h3>
        ...
        <div class="lg:card flex flex-row justify-center md:flex-col items-center md:py-0 lg:py-0">
             <div class='md:flex md:flex-col md:items-center'>
                <div class="p-4 md:text-center md:w-[70%] md:h-[10rem]">
                     <h3 class="text-black font-belleza text-[17px] md:text-[14px] lg:text-xl font-semibold mb-2 lg:mt-[1rem] lg:mb-[1rem]">Limpieza energética y autodefensa psíquica. 
                     </h3>
